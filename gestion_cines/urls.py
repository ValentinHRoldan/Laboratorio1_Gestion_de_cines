"""
URL configuration for gestion_cines project.
...
from apps.funciones.api.viewsets import PeliculaViewSet, FuncionViewSet, SalaViewSet, TipoFormatoViewSet, AsientoViewSet
